...
//后端项目的URL根路径 为自己电脑ip地址+端口,如果是部署到云服务器中，则前面的ip地址为云服务器中的地址
let baseUrl = "http://192.168.111.1:8090/emos-api/"

//设置全局变量$baseUrl
app.config.globalProperties.$baseUrl = baseUrl 

//封装全局Ajax公共函数，后面就不用重复写ajax，直接调用封装的$http
